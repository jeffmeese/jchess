...
TEST_F(BitboardTest, TestDoublePushMove)
{
  ...
  jcl::Move move(1, 4, 3, 4, jcl::Piece::Pawn, jcl::Move::Type::EpPush, &mBitBoard);
...
TEST_F(BitboardTest, TestCapture)
{
  ...
  jcl::Move move(3, 4, 4, 3, jcl::Piece::Pawn, jcl::Move::Type::Capture, &mBitBoard, jcl::Piece::Pawn);
  EXPECT_EQ(mBitBoard.makeMove(&move), true);
...
TEST_F(BitboardTest, TestWhitePromotion)
{
  ...
  jcl::Move queenMove(6, 0, 7, 0, jcl::Piece::Pawn, jcl::Move::Type::Promotion, &mBitBoard, jcl::Piece::None, jcl::Piece::Queen);
  ...
  jcl::Move rookMove(6, 0, 7, 0, jcl::Piece::Pawn, jcl::Move::Type::Promotion, &mBitBoard, jcl::Piece::None, jcl::Piece::Rook);
  ...
  jcl::Move bishopMove(6, 0, 7, 0, jcl::Piece::Pawn, jcl::Move::Type::Promotion, &mBitBoard, jcl::Piece::None, jcl::Piece::Bishop);
  ...
  jcl::Move knightMove(6, 0, 7, 0, jcl::Piece::Pawn, jcl::Move::Type::Promotion, &mBitBoard, jcl::Piece::None, jcl::Piece::Knight);
...
TEST_F(BitboardTest, TestBlackPromotion)
{
  ...
  jcl::Move queenMove(1, 7, 0, 7, jcl::Piece::Pawn, jcl::Move::Type::Promotion, &mBitBoard, jcl::Piece::None, jcl::Piece::Queen);
  EXPECT_EQ(mBitBoard.makeMove(&queenMove), true);
  ...
  jcl::Move rookMove(1, 7, 0, 7, jcl::Piece::Pawn, jcl::Move::Type::Promotion, &mBitBoard, jcl::Piece::None, jcl::Piece::Rook);
  EXPECT_EQ(mBitBoard.makeMove(&rookMove), true);
  ...
  jcl::Move bishopMove(1, 7, 0, 7, jcl::Piece::Pawn, jcl::Move::Type::Promotion, &mBitBoard, jcl::Piece::None, jcl::Piece::Bishop);
  EXPECT_EQ(mBitBoard.makeMove(&bishopMove), true);
  ...
  jcl::Move knightMove(1, 7, 0, 7, jcl::Piece::Pawn, jcl::Move::Type::Promotion, &mBitBoard, jcl::Piece::None, jcl::Piece::Knight);
  EXPECT_EQ(mBitBoard.makeMove(&knightMove), true);
...
TEST_F(BitboardTest, TestWhiteEnPassantCapture)
{
  ...
  jcl::Move move(4, 3, 5, 2, jcl::Piece::Pawn, jcl::Move::Type::EpCapture, &mBitBoard, jcl::Piece::Pawn);
  EXPECT_EQ(mBitBoard.makeMove(&move), true);
...
TEST_F(BitboardTest, TestBlackEnPassantCapture)
{
  ...
  jcl::Move move(3, 3, 2, 2, jcl::Piece::Pawn, jcl::Move::Type::EpCapture, &mBitBoard, jcl::Piece::Pawn);
  EXPECT_EQ(mBitBoard.makeMove(&move), true);
  EXPECT_EQ(mBitBoard.getPawns(jcl::Color::White), whitePawns);
  EXPECT_EQ(mBitBoard.getPawns(jcl::Color::Black), blackPawns);
  EXPECT_EQ(mBitBoard.getEnpassantColumn(), jcl::Board::INVALID_ENPASSANT_COLUMN);
...
TEST_F(BitboardTest, TestKingMoves)
{
  ...
  jcl::Move blackMove(7, 4, 6, 4, jcl::Piece::King, jcl::Move::Type::Quiet, &mBitBoard);
  ...
  jcl::Move whiteMove(0, 4, 1, 4, jcl::Piece::King, jcl::Move::Type::Quiet, &mBitBoard);
...
TEST_F(BitboardTest, TestCastleMoves)
{
  ...
  jcl::Move whiteKingCastle(0, 4, 0, 6, jcl::Piece::King, jcl::Move::Type::Castle, &mBitBoard);
  ...
  jcl::Move whiteQueenCastle(0, 4, 0, 2, jcl::Piece::King, jcl::Move::Type::Castle, &mBitBoard);
  ...
  jcl::Move blackQueenCastle(7, 4, 7, 2, jcl::Piece::King, jcl::Move::Type::Castle, &mBitBoard);
  ...
  jcl::Move blackKingCastle(7, 4, 7, 6, jcl::Piece::King, jcl::Move::Type::Castle, &mBitBoard);
